...
public class MainActivity extends AppCompatActivity
    ...
    public final View.OnClickListener mFABClickListener = new View.OnClickListener() {
        @Override
    ...
    public MenuItem mNotificationButton;
    public MenuItem mMessagesButton;
    public CallbackManager callbackManager;
    public Snackbar loginSnackbar = null;
    @SuppressWarnings("FieldCanBeLocal") // Will be garbage collected as a local variable
    public SharedPreferences.OnSharedPreferenceChangeListener listener;
    public boolean requiresReload = false;
    public String mUserLink = null;
    ...
    public void onBackPressed() {
       ...
       /* else if(navigation.getSelectedItemId()!=0){
            navigation.setSelectedItemId(0);
        }*/

        else if ( navigation.getSelectedItemId()==R.id.navigation_home && mWebView.canGoBack()) {
            mWebView.goBack();
